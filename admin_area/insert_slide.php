    ...
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li>
                ...
                <i class="fa fa-dashboard"></i> ควบคุม / เพิ่มสไลด์
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    <i class="fa fa-money fa-fw"></i> เพิ่มสไลด์
...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if($count<4){
            ...
            echo "<script>alert('เพิ่มสไลค์เรียบร้อย')</script>";
            
            echo "<script>window.open('index.php?view_slides','_self')</script>";
            
        }else{
            
           echo "<script>alert('กรุณาใส่ไม่เกิน 4 รูปภาพ')</script>"; 
