    ...
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li>
                ...
                <i class="fa fa-dashboard"></i> ควบคุใ / แก้ไขสไลด์
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    <i class="fa fa-money fa-fw"></i> แก้ไขสไลด์
                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6" >
                            ...
                            <input  type="submit" name="update" value="อัปเดต" class="btn btn-primary form-control">
...
<?php  
    ...
    if(isset($_POST['update'])){
        ...
        if($run_update_slide){
            ...
            echo "<script>alert('สไลด์ได้รับการอัปเดตเรียบร้อยแล้ว')</script>"; 
