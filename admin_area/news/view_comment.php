...
if(isset($_GET["Action"]))
    ...
    if($query){
        ...
        echo "<script>window.open('index.php?QuestionID'".$_GET["QuestionID"]."'','_self')</script>";
    }
...
<table cellpadding="1" class="table table-bordered border-primary" cellspacing="1">
  ...
  <tr class='text-dark'>
    ...
    <td>เวลาที่ตอบกระทู้ :
    <?php echo $result2["CreateDate"];?><a href="JavaScript:if(confirm('ยืนยันที่จะลบ?')==true){window.location='index.php?delete_comment=<?php echo $result2["ReplyID"];?>';}"> &nbsp;ลบ</a></td>
  </tr>
</table><br>
<?php
}
...
<br>
 <br>
<br>
<form action="index.php?QuestionID=<?php echo $_GET["QuestionID"];?>&Action=Save" method="post" name="frmMain" id="frmMain">
  <table  cellpadding="1" class="table table-bordered" cellspacing="1">
    <tr class='text-dark'>
